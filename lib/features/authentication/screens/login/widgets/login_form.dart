        ...
        child: Column(
          children: [
              ...
              children: [
                Obx(
                  () => Checkbox(
                    ...
                    onChanged: (value) => controller.hidePassword.value = !controller.hidePassword.value,
                  ),
                ),
                Text("تذكر بياناتي ", style: Theme.of(context).textTheme.bodyLarge),
              ],
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(onPressed: () => controller.login(), child: const Text("تسجيل الدخول")),
            ),
          ],
        ),
      ),
